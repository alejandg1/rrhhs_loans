...
urlpatterns += [
    ...
    path('country/create', country.CountryCreateView.as_view(),
         name="country_create"),
    path('country/update/<int:pk>',
         country.CountryUpdateView.as_view(), name="country_update"),
    path('country/delete/<int:pk>',
         country.CountryDeleteView.as_view(), name="country_delete"),
]
...
urlpatterns += [
    path('profile/update', profile.ProfileUpdateView.as_view(),
         name='profile_update'),
    path('change/password', profile.UserPasswordUpdateView.as_view(),
